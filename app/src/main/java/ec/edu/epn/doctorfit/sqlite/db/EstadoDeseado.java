...
/**
 * Entity mapped to table "ESTADO_DESEADO".
 */
public class EstadoDeseado {
    ...
    private transient EstadoDeseadoDao myDao;
    ...
    public EstadoDeseado(Long id) {
        this.id = id;
    }

    public EstadoDeseado(Long id, String estadoFuturo, long idUsuario) {
        this.id = id;
    ...
    public void __setDaoSession(DaoSession daoSession) {
        ...
        myDao = daoSession != null ? daoSession.getEstadoDeseadoDao() : null;
    }
